...
const data = {
  ...
  github: chalk.gray('https://github.com/') + chalk.green('alqahtani'),
  linkedin: chalk.gray('https://linkedin.com/in/') + chalk.blue('ahmedalqahtani'),
  web: chalk.cyan('https://asd.sa'),
  npx: chalk.red('npx') + ' ' + chalk.white('ahmed'),
